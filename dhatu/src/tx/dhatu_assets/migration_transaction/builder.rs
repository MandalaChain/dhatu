use crate::tx::extrinsics::{funds_reserve::traits::FundsReserveTraits, prelude::BlockchainClient};
    ...
    Reserve: FundsReserveTraits,
{
    ...
    fn set_client(&mut self, client: crate::tx::extrinsics::prelude::BlockchainClient) -> &mut Self {
